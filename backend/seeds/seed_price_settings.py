...
try:
    from models.models import PriceSettings, db  # when inside backend/
except ImportError:
    from backend.models.models import PriceSettings, db  # type: ignore
...
# ------------------------------------------------------------------------------
def seed(
    seed_path: str | None = None, row_id: int = 1, overwrite: bool = False, dry_run: bool = False
) -> None:
    """
