...
def _load_payload(seed_file: Optional[Path]) -> Tuple[list[dict], list[dict]]:
    """
...
def _parse_args() -> argparse.Namespace:
    ...
    ap.add_argument("--file", help=f"Path to seed file (overrides ${ENV_FILE_VAR_PRIMARY} / ${ENV_FILE_VAR_LEGACY})", default=None)
