...
class Car(db.Model):
    ...
    # Energy / consumption
    consumption_kwh_per_100km = db.Column(Numeric(6, 2), nullable=True)  # prefer None over 0.00 when unknown
    ...
    # ---- API serialization ----
    def to_dict(self, tire_change_price_year: Optional[Decimal] = None):
        """
