...
from .depreciation import predict_future_value_from_today_price, DepreciationParams, estimate_new_price_from_today_price
...
def compute_derived(car) -> dict:
    ...
    tires_total = (
        to_num(getattr(car, "summer_tires_price", 0.0)) +
        to_num(getattr(car, "winter_tires_price", 0.0))
    )
