...
from utils.charging import estimate_dc_10_80_minutes, estimate_ac_0_100_hours
...
def update_cars():
    try:
        ...
        for p in data:
            ...
            car.dc_time_min_10_80     = to_num(p.get('dc_time_min_10_80'), getattr(car, 'dc_time_min_10_80', 0))
            ...
            car.ac_time_h_0_100       = to_num(p.get('ac_time_h_0_100'), getattr(car, 'ac_time_h_0_100', 0))
