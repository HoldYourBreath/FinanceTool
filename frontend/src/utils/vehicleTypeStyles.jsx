...
export function rowBgFor(typeRaw) {
  ...
  if (["phev", "plug-in hybrid", "plugin hybrid", "plug in hybrid"].includes(t))
    return TYPE_ROW_BG.PHEV;
  if (["diesel"].includes(t)) return TYPE_ROW_BG.Diesel;
  if (["bensin", "petrol", "gasoline", "gas"].includes(t))
    return TYPE_ROW_BG.Bensin;
