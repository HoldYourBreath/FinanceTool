...
const PREMIUM_BRANDS = new Set(["BMW","Mercedes","Audi","Polestar","Tesla","Volvo"]);
...
function brandFromModel(model) {
  ...
  const map = {
    ...
    mb: "Mercedes", "mercedes": "Mercedes", "mercedes-benz": "Mercedes",
  };
...
export function estimateTireSetPrice(car, season = "summer") {
  ...
  if (accel > 0 && accel <= 5.0) price *= 1.10;
